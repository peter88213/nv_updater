[![Download the latest release](docs/img/download-button.png)](https://github.com/peter88213/nv_updater/raw/main/dist/nv_updater_v5.3.3.pyz)
...
Download the latest release [nv_updater_v5.3.3.pyz](https://github.com/peter88213/nv_updater/raw/main/dist/nv_updater_v5.3.3.pyz) (21 KB)

- Launch *nv_updater_v5.3.3.pyz* by double-clicking (Windows desktop),
- or execute `python nv_updater_v5.3.3.pyz` (Windows), resp. `python3 nv_updater_v5.3.3.pyz` (Linux) on the command line.
...
The package is also available in zip format: [nv_updater_v5.3.3.zip](https://github.com/peter88213/nv_updater/raw/main/dist/nv_updater_v5.3.3.zip) (21 KB)

- Extract the *nv_updater_v5.3.3* folder from the downloaded zipfile "nv_updater_v5.3.3.zip".
